...
* y2: probability of repaying a loan early
* y3: timing of default or early repayment (only using actual observations)

This version does not use counterfactuals: When there is default, there is no timeline for
early repayment. These counterfactuals are modeled in a different network. 
